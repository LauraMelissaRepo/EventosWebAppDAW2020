...
{
    public partial class EventosWebAppContext : DbContext
    {
        public EventosWebAppContext()
        {
        }

        public EventosWebAppContext(DbContextOptions<EventosWebAppContext> options)
            : base(options)
        {
        }
